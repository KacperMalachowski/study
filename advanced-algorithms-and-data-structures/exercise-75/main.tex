...
Wartość spodziewana - spodziewany wynik doświadczenia losowego przy założonym prowdopodobieństwie jego wystąpienia \cite{MatKon}.

Ciąg powtórzeń - ciąg dowolnej długości powtarzajacych się po sobie elementów.
...
\begin{thebibliography}{00}
  \bibitem{MatKon}
  Graham Ronald L., Knuth Donald E., Oren Patashnik. "Matematyka konkretna", 2011
\end{thebibliography}
\end{document}